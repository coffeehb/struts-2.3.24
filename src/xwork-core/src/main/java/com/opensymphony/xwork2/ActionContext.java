...
/**
 * The ActionContext is the context in which an {@link Action} is executed. Each context is basically a container of objects an action needs for execution like
 * the session, parameters, locale, etc.
 * <p>
 * <p/>
 * The ActionContext is thread local which means that values stored in the ActionContext are unique per thread. See the {@link ThreadLocal} class for more
 * information. The benefit of this is you don't need to worry about a user specific action context, you just get it:
 * <p/>
 * <ul>
...
public class ActionContext implements Serializable {
     ...
     *
     * @return the map of conversion errors which occurred when executing the action or an empty map if there were no errors.
     */
